...
--
-- Host: 127.0.0.1
-- Generation Time: 09. Des, 2021 18:25 PM
...
(19, ' Mandags Golf', 'Søm', '2021-12-08', '2021-12-27', 41, 11, 16);
...
(3, 'Simen', 'Sundbø', 'St. Olavs vei 13', 4631, 'Kristiansand', 'sim123@live.no', 12345678, '0', NULL, '1999-10-12', 'Mann', '2020-11-23 22:07:39'),
...
(16, 'Andreas', 'Martinsen', 'Urds Vei', 4630, 'Kristiansand', 'Andreas@live.no', 96542132, '1', NULL, '1996-12-01', 'Mann', '2021-12-02 17:32:35'),
(17, 'Simen', 'Tryfoss', 'St. Olavs vei 3C', 4631, 'Kristiansand', 'simZ@live.no', 98562232, '1', NULL, '1999-05-27', 'Mann', '2021-12-02 17:33:40'),
(18, 'Jonas', 'Fidjeland', 'Hyllelien 17', 4631, 'Kristiansand', 'JonasF@outlook.com', 89061025, '1', NULL, '1999-05-23', 'Mann', '2021-12-02 17:34:38'),
(19, 'Maren', 'Lislevand', 'StadioVeien', 4631, 'Kristiansand', 'Maren@test.no', 99852133, '1', NULL, '1999-03-12', 'Mann', '2021-12-02 17:35:47'),
(20, 'Sondre', 'Monge', 'Marviksveien 13', 4631, 'Kristiansand', 'Sondre@live.no', 99556622, '1', NULL, '1999-05-31', 'Mann', '2021-12-02 17:36:46'),
(41, 'Elias', 'Gauslaa', 'Urds Vei', 4630, 'Kristiansand', 'EliasG@live.no', 12345678, '1', NULL, '2021-12-03', 'Mann', '2021-12-03 15:58:41'),
(42, 'eli', 'Gauslaa', 'Urds Vei', 4630, 'Kristiansand', 'Elias2@live.no', 12345678, '1', NULL, '2021-12-03', 'Mann', '2021-12-03 15:59:01');
...
--
-- Tabellstruktur for tabell `profilepic`
--
...
--
-- Dataark for tabell `profilepic`
--

INSERT INTO `profilepic` (`id`, `path`, `member_id`) VALUES
(1, 'assets/img/3.jpeg', 3),
(7, 'assets/img/16.png', 16),
(8, 'assets/img/11.png', 11);
...
--
-- Begrensninger for tabell `profilepic`
--
ALTER TABLE `profilepic`
  ADD CONSTRAINT `member_id` FOREIGN KEY (`member_id`) REFERENCES `members` (`id`);
COMMIT;
