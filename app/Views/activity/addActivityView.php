        ...
        <div class="col-md-5">
            <div class="p-3 py-5">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h4 class="text-right">Opprett aktivitet</h4>
                    <a class="btn btn-primary btn-rounded" href="<?= base_url('/listActivities') ?>">Tilbake</a>
                </div>
            ...
            <div class="mt-5 text-center">
                <button class="btn btn-primary btn-rounded" type="submit">Opprett aktivitet</button>
                <p class="m-5"></p>
            </div>
            </form>
        </div>
